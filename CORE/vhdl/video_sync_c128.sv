//============================================================================
//
//  C128 Video sync (MiSTer C128_MiSTer/rtl/video_sync.sv)
//  Copyright (C) 2023 Erik Scheffers
//
//  Renamed to video_sync_c128 so it can coexist with M2M's C64 video_sync.vhd
//  (used for the VIC path). Instantiated for the VDC HDMI path in main.vhd.
//
//============================================================================

module video_sync_c128 (
   input        reset,
	input        clk32,
   input        pause,
   ...
   // Vivado xvlog requires reg for outputs driven by always blocks
   // (Quartus accepted plain output). Combinational assigns stay wire.
